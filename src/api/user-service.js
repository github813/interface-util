...
export default {
  //
  //http://192.168.1.230:8001/interface-util/interface/detail/saveInterfaceDetail
  saveInterfaceDetail: params => {
    return API.POST(`${base}/interface-util/interface/detail/saveInterfaceDetail`, params)
  },
